...
! function(a) {
    ...
    c["line-pulse"] = function() {
        ...
        var b = { name: "line-pulse", maskClick: !1, callback: function() {} };
        if (arguments)
        ...
        e.setAttribute("id", "_mask"), e.style.position = "fixed", e.style.top = "0", e.style.left = "0", e.style.bottom = "0", e.style.right = "0", e.style.overflow = "hidden", e.style["z-index"] = 99998, e.style["background-color"] = "#000", e.style.opacity = .6, e.style.zoom = 1, b.allowHide && e.addEventListener("click", function() { a.hideLoading() }, !1), a("body").append(e), a("body").append(c[b.name]()), b.callback()
