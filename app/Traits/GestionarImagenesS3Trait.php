...
trait GestionarImagenesS3Trait
{
    use GestionarDirectoriosAndObjetosS3Trait;
    public function storeImagenFormatoFileS3($imagen, $imagenAnterior, $nombreImagen, $directorio, $accion)
    {
        $nuevoDirectorio = Config::get('variablesGlobales.bucketS3') . "/$directorio";
        // CREAR DIRECTORIO
    ...
    public function storeImagenFormatoBase64($imagen, $imagenAnterior, $nombreImagen, $directorio, $accion)
    {
        $nuevoDirectorio = Config::get('variablesGlobales.bucketS3') . "/$directorio";
        // CREAR DIRECTORIO
        $this->crearDirectorioS3($nuevoDirectorio);
