...
class GruposController extends Controller
{
    ...
    public function index(Request $req)
    {
        ...
        return view('administracion/almacen/Grupos/grupos', $array);
    }
    ...
    public function create(Request $req)
    {
        ...
        return view('administracion/almacen/Grupos/crearGrupo', $array);
    ...
    public function editarGrupo(Request $req, $id)
    {
        ...
        return view('administracion/almacen/Grupos/editarGrupo', $array);
    }
    ...
    public function verDetalleGrupo(Request $req, $id)
    {
        ...
        return view('administracion/almacen/Grupos/detalleGrupo', $array);
    }
    ...
    protected function itemsDetalleGrupo($idGrupo)
    {
        try {
            $listaGrupo = DB::table('detalle_grupo')
                ...
                ->select('detalle_grupo.Codigo', 'articulo.Descripcion', 'articulo.IdMarca', 'articulo.Precio', 'articulo.Stock', 'articulo.Codigo AS codigoBarra', 'grupos_productos_servicios.NombreGrupo', 'grupos_productos_servicios.IdTipoMoneda', 'detalle_grupo.IdGrupo', 'articulo.IdTipo AS idTipoArticulo', 'articulo.IdArticulo', 'articulo.IdCategoria', 'articulo.Estado')
    ...
    public function eliminarGrupo(Request $req, $idGrupo)
    {
        ...
        return redirect('administracion/almacen/grupos')->with('status', 'El grupo se eliminó Correctamente');
    }
