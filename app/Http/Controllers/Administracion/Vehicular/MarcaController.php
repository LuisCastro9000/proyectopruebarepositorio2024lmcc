...
class MarcaController extends Controller
{
    ...
    public function store(Request $req) {
        try{
            ...
            return redirect('administracion/vehicular/marca')->with('status', 'Se creo la Marca correctamente');
        } catch (Exception $ex){
            echo $ex->getMessage();
        }
    }
    ...
    public function update(Request $req, $id) {
        try{
            ...
            return redirect('administracion/vehicular/marca')->with('status', 'Se actualizo la Marca correctamente');
    ...
    public function delete($id) {
        try{
            ...
            return redirect('administracion/vehicular/marca')->with('status', 'Se elimino la Marca correctamente');
