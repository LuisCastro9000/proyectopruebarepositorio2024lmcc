...
class ModeloController extends Controller
{
    ...
    public function store(Request $req) {
        try{
            ...
            return redirect('administracion/vehicular/modelo')->with('status', 'Se creo Tipo correctamente');
        } catch (Exception $ex){
            echo $ex->getMessage();
        }
    }
    ...
    public function update(Request $req, $id) {
        try{
            ...
            return redirect('administracion/vehicular/modelo')->with('status', 'Se actualizo el Modelo correctamente');
    ...
    public function delete($id) {
        try{
            ...
            return redirect('administracion/vehicular/modelo')->with('status', 'Se elimino el Modelo correctamente');
