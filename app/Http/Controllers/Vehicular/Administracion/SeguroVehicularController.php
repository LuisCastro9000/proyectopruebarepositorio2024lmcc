...
class SeguroVehicularController extends Controller
{
    public function index(Request $req)
    {
        ...
        return view('vehicular/seguro/seguros', $array);
    }
    ...
    public function create(Request $req)
    {
        ...
        return view('vehicular/seguro/crear', $array);
    }
    ...
    public function store(Request $req)
    {
        try {
            ...
            return redirect('vehicular/administracion/seguros-vehiculares')->with('status', 'Se creo seguro vehicular correctamente');
        } catch (Exception $ex) {
            echo $ex->getMessage();
        }
    }
    ...
    public function edit(Request $req, $id)
    {
        ...
        return view('vehicular/seguro/editar', $array);
    }
    ...
    public function update(Request $req, $id)
    {
        try {
            ...
            return redirect('vehicular/administracion/seguros-vehiculares')->with('status', 'Se actualizo cliente correctamente');
    ...
    public function delete($id)
    {
        try {
            ...
            return redirect('vehicular/administracion/seguros-vehiculares')->with('status', 'Se elimino seguro vehicular correctamente');
