...
class ReporteGuiaController extends Controller
{
    public function index(Request $req){
        ...
        $reporteClientes = $this->getVentasClientes($idSucursal);
        dd($reporteClientes);
    ...
    public function store(Request $req) {
        ...
        $clientesGraf = $loadDatos->grafgetVentasClientesFiltrados($idSucursal, $inputcliente, $tipoPago, $fecha, $fechaIni, $fechaFin);
    ...
    public function exportExcel( $inputcliente=null, $tipoPago=null, $fecha=null, $ini=null, $fin=null)
    {
      ...
      Excel::create('Reporte Clientes', function ($excel) use($array){
                ...
                $sheet->loadView('excel/reporteClientesExcel', $array);
              });
          })->download('xlsx');
    }
    ...
    public function getVentasClientes($idSucursal) {
        try{
            $ventas= DB::table('guia_remision as gr')
                        ...
                        ->join('usuario','ventas.IdUsuario', '=', 'usuario.IdUsuario')
