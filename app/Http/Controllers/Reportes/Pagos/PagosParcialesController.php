...
use App\Exports\ExcelReportePagosParciales;
...
class PagosParcialesController extends Controller
{
    public function index(Request $req)
    {
        ...
        $pagosParciales = DB::select('call sp_getPagosProveedoresParciales(?, ?, ?)', array($idSucursal, $fechas[0], $fechas[1]));
        ...
        return view('reportes/pagos/reportesPagosParciales', $array);
    }
    ...
    public function exportExcel($fecha, $ini, $fin)
    {
        ...
        return Excel::download(new ExcelReportePagosParciales($pagosParciales), 'Reporte Pagos - Pagos Parciales.xlsx');
    ...
    $sheet->loadView('excel/excelComprasPagosParciales', $array);
    });
    })->download('xlsx');*/
    }
}
