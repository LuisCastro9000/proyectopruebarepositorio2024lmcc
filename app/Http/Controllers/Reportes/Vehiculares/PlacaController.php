...
namespace App\Http\Controllers\Reportes\Vehiculares;
...
class PlacaController extends Controller
{
    public function index(Request $req){
        if ($req->session()->has('idUsuario')) {
            ...
            return view('reportes/vehiculares/placa', $array);
        }else{
            Session::flush();
    ...
    public function exportExcel($inputPlaca, $fecha, $ini, $fin)
    {
            ...
            /*$array = ['reporteVehiculares' => $reporteVehiculares];

    		Excel::create('Reporte Vehiculares por Placa', function ($excel) use($array){
        	         $excel->sheet('Reporte Vehiculares por Placa', function ($sheet) use($array) {
                   $sheet->getStyle('A:I', $sheet->getHighestRow())->getAlignment()->setWrapText(false);
                   $sheet->loadView('excel/excelVehicularesPlacas', $array);
                });
            })->download('xlsx');*/
    }
