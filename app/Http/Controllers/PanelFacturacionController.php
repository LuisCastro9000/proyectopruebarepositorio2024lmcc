...
class PanelFacturacionController extends Controller
{
    ...
    public function getDatosDocumentosAjax(Request $req)
    {
        if ($req->ajax()) {
            ...
            return view('areas.areaFacturacion._tablaRespuestaAjax', compact('datosDocumento', 'totalDocumentoPendientesSoles', 'totalDocumentoPendientesDolares', 'totalDocumentoPendientesGuias', 'idDocumento'));
        }
