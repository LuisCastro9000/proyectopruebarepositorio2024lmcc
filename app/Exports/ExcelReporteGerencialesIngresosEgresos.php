...
class ExcelReporteGerencialesIngresosEgresos implements FromView
{
    public function view(): View
    {
    	$ingresosEgresos = collect($this->resultArray);
        return view('excel.ReporteGerencialIngresosEgresosExcel', [
