...
class ExcelReporteVentasVendedor implements FromView
{
    public function view(): View
    {
    	...
    	$reporteVendedores = collect($this->resultArray);
        return view('excel.reporteVendedoresExcel', [
            'reporteVendedores' => $reporteVendedores
        ]);
    }
