...
class ExcelReporteBajaProductos implements FromView
{
    public function view(): View
    {
    	...
    	$bajaProductos = collect($this->resultArray);
        return view('excel.excelBajaProductos', [
            'bajaProductos' => $bajaProductos
        ]);
    }
