     ...
     <section>
         <div class="row">
             <div class="col-xl-5 col-lg-6">
                 <div class="row">
                     <div class="col-lg-6">
                         <form id="formPagosSinVerificar" action="{{ route('pagos-plan-sucripcion.index') }}"
                             method="POST">
                             @method('GET')
                             <input type="hidden" name="inputEstadoPago" value="Sin Verificar">
                             <div class="card widget-flat cursor-pointer"
                                 onclick="document.getElementById('formPagosSinVerificar').submit()">
                                 <div class="card-body">
                                     <div class="float-end">
                                         <i class="mdi mdi-currency-usd widget-icon"></i>
                                     </div>
                                     <h5 class="text-muted fw-normal mt-0" title="Pagos sin Verificar">
                                         Pagos sin Verificar</h5>
                                     <h3 class="mt-3 mb-3">{{ $cantidadPagosSinVerificar }}</h3>
                                     <p class="mb-0 text-muted">
                                         <span class="badge badge-danger-lighten">Consultar</span>
                                     </p>
                                 </div> <!-- end card-body-->
                             </div> <!-- end card-->
                         </form>
                     ...
                     <div class="col-lg-6">
                         <form id="formPagosRenovados" action="{{ route('pagos-plan-sucripcion.index') }}" method="POST">
                             @method('GET')
                             <input type="hidden" name="inputEstadoPago" value="Renovado">
                             <div class="card widget-flat cursor-pointer"
                                 onclick="document.getElementById('formPagosRenovados').submit()">
                                 <div class="card-body">
                                     <div class="float-end">
                                         <i class="mdi mdi-currency-usd widget-icon"></i>
                                     </div>
                                     <h5 class="text-muted fw-normal mt-0" title="Pagos Renovados">
                                         Pagos Renovados</h5>
                                     <h3 class="mt-3 mb-3">{{ $cantidadPagosRenovados }}</h3>
                                     <p class="mb-0 text-muted">
                                         <span class="badge badge-orange-lighten">Consultar</span>
                                     </p>
                                 </div> <!-- end card-body-->
                             </div> <!-- end card-->
                         </form>
