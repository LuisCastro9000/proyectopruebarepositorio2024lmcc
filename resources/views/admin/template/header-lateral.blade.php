...
<div class="leftside-menu">
    ...
    <a href="{{ route('admin.dashboards') }}" class="logo text-center logo-light">
        <span class="logo-lg">
            <img src="{{ asset('assets/img/autocontrolLogo.png') }}" alt="" height="90">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('assets/img/autocontrolLogo.png') }}" alt="" height="90">
        </span>
    ...
    <div class="h-100 mt-md-3" id="leftside-menu-container" data-simplebar="">

        <!--- Sidemenu -->
        <ul class="side-nav">

            <li class="side-nav-title side-nav-item">Panel Principal</li>
            ...
            <li class="side-nav-item">
                <a href="{{ route('pagos-plan-sucripcion.index') }}" class="side-nav-link">
                    <i class="uil-calender"></i>
                    <span>Pagos Plataforma</span>
                </a>
            </li>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEcommerce">
                    <ul class="side-nav-second-level">
                        ...
                        <li>
                            <a href="{{ route('admin.tipo-cambio.index') }}"> TipoCambio </a>
                        </li>
                    </ul>
                </div>
            </li>
