...
@section('content')
    ...
    <div class="container mt-4">
        <div class="jumbotron bg-white pt-3 pb-2 border-radius--10">
            {!! Form::open(['url' => '/reportes/vehiculares/filtrar-ganancias', 'method' => 'POST', 'files' => true]) !!}
            {{ csrf_field() }}
            <div class="row mt-4">
                <div class="col-md-4">
                    ...
                    <section class="d-flex justify-content-center flex-wrap">
                        ...
                        <div class="form-group mx-0 mx-md-3">
                            <a class="p-0" target="_blank"
                                href='{{ url("reportes/vehiculares/filtrar-ganancias/excel-ganancia/$_inputPlaca/$_inputMecanico/$fecha/$ini/$fin") }}'>
                ...
                <div class="col-md-6 mt-4 order-md-4">
                ...
                <div class="col-md-6 mt-4 order-md-5">
                ...
                @if ($subniveles->contains('IdSubNivel', 46))
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-toggle="tab" data-target="#home"
                            type="button" role="tab" aria-controls="home" aria-selected="true">Ganacias en
                            Soles</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-toggle="tab" data-target="#profile"
                            type="button" role="tab" aria-controls="profile" aria-selected="false">Ganacias en
                            Dólares</button>
                    </li>
                @endIf
            </ul>
