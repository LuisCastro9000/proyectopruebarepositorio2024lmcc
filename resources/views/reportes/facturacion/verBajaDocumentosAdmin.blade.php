		...
		@extends('layouts.app')
		@section('title', 'Baja Documentos')
		@section('content')	
            <div class="container">
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        <h6 class="page-title-heading mr-0 mr-r-5">Listado de Baja de Documentos</h6>
                    </div>
                    <!-- /.page-title-left -->
                </div>
                @if (session('status'))
                                    ...
                                    <table id="table" class="table table-responsive-sm" style="width:100%">
                                        <thead>
                                            <tr class="bg-primary">
                                                ...
                                                <th scope="col">Usuario Principal</th>
