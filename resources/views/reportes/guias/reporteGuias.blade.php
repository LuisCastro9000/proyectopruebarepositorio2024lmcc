		...
		@section('content')
            <div class="container">
                ...
                @endif
                {!!Form::open(array('url'=>'/reportes/guias','method'=>'POST','files'=>true))!!}
                    {{csrf_field()}}
                    ...
                    <div class="col-md-3 mt-4 order-md-3 order-last">
                        <div class="form-group container ">
                            ...
                            <button type="submit" class="btn btn-primary">Buscar</button>
														<a class="p-5" target="_blank" href='{{ url("reportes/guias/excel-guias/$inputcliente/$IdTipoPago/$fecha/$ini/$fin") }}' >
                                            ...
                                            <tbody>
                                               @foreach($reporteClientes as $reportCliente)
                                                <tr>
                                                    ...
                                                    <td>{{$reportCliente->codigoError == 0 ? '': $reportCliente->codigoError}}</td>
