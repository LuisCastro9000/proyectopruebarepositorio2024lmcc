<table id="table" class="table table-responsive-sm" style="width:100%">
    <thead>
        <tr class="bg-primary">
            ...
            <th align="center" scope="col" style="font-weight:bold">FECHA INICIO-ATENCIÓN</th>
            <th align="center" scope="col" style="font-weight:bold">FECHA FIN-ATENCIÓN</th>
            <th align="center" scope="col" style="font-weight:bold">TIEMPO DE RETRASO</th>
    ...
    <tbody>
        @foreach ($datosExportar as $dato)
            <tr>
                ...
                <td width="40" align="center">{{ $dato->FechaRegistro }}</td>
                <td width="40" align="center">{{ $dato->FechaFinAtencion }}</td>
                <td width="40" align="center">{{ $dato->TiempoRetraso }}</td>
