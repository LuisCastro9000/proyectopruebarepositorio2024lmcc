...
<body class="sidebar-horizontal">
                                ...
                                <div class="widget-bg">
                                    <div class="widget-body clearfix form-material">
                                        ...
                                        <div
                                            ...
                                            <button id="btnGuardarOrdenCompra" class="btn btn--celeste guardarCompra"
                                                value="Pendiente" type="submit">Generar orden de Compra</button>
                                        </div>
    ...
    <script>
        ...
        function agregarProducto(id) {
            if (arrayIds.includes(id) == true) {
                ...
                $('#tablaAgregado tr:last').after('<tr id="row' + iden + '"><td><input id="pro' + iden +
                    ...
                    '</td><td><input id="cost' + iden + '" name="PrecioCosto[]" onchange="calcular(this, ' + iden +
                    ');" type="number" value="' + redondeo(precioCosto) + '">' +
                    '</td><td><input id="cant' + iden +
                    '" name="Cantidad[]" onkeydown="return false" onchange="calcular(this, ' + iden +
                    ');" type="number" min="1" step="' + step + '" value="' + cantidad + '" style="width:100px">' +
                    '</td><td><input id="imp' + iden + '" name="Importe[]" step="any" readonly type="number" value="' +
                    redondeo(importeFinal) + '" style="width:100px">' +
                    '</td><td><button id="btn' + iden + '" onclick="quitar(' + iden + ',' + id +
                ...
                valores.Id = id;
                valores.Codigo = 'PRO-' + id;
                valores.Row = iden;
                valores.PrecioCosto = parseFloat(precioCosto);
                valores.Cantidad = parseInt(cantidad, 10);
                valores.Importe = parseFloat(importeFinal);
            ...
            if (array.length > 0) {
                ...
                /*for(var i=0; i<array.length; i++){
                    if(datos.Id == array[i]["Id"]){
                        ...
                        array[i]["PrecioCosto"] = parseFloat(datos.PrecioCosto);
                        array[i]["Importe"] += parseFloat(datos.Importe);
                        $('#'+datos.Id).replaceWith('<div id="'+datos.Id+'"><input name="Id[]" value="'+datos.Id+'"></input>'
                                                    +'<input name="Codigo[]" value="'+datos.Codigo+'"></input>'
                                                    +'<input name="Importe[]" value="'+array[i]["Importe"]+'"></input>'
                                                    +'</div>');
        ...
        //                                                         alert(data[1]);
        //                                                         window.location =
        //                                                             '../operaciones/compras/comprobante-generado/' +
        //                                                             data[2];
        //                                                     }
        //                                                 }
        //                                             }
        ...
        //     $.ajax({
        //         type: 'post',
        //         url: 'orden-compra/guardar-orden-compra',
        //         data: {
        //             "_token": "{{ csrf_token() }}",
        //             "proveedor": proveedor
        //         },
                        ...
                        if (data[0] == 'alert2') {
                            ...
                            if (data[0] == 'alert3') {
                                ...
                                if (data[0] == 'succes') {
                                    alert(data[1]);
                                    window.location =
                                        '../../operaciones/compras/comprobante-orden-compra/' + data[2];
                                }
                            }
                        }
                    }
    ...
    <script>
        $(function() {
            $("#tipoMoneda").on('change', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: 'crear-compra/select-productos-sin-tipo-cambio',
                    data: {
                        'tipoMoneda': tipoMoneda
                    },
                    success: function(data) {
                        ...
                        for (var i = 0; i < data["data"].length; i++) {
                            ...
                            $('#listaProductos').append(
                                ...
                                '<div class="card-footer">' +
                                '<div class="product-info col-12">' +
                                '<a class="bg-info color-white" onclick="agregarProducto(' +
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data["data"].length; i++) {
                            ...
                            $('#listaProductos').append('<div class="product col-12 col-md-6">' +
                                ...
                                '<div class="card-footer">' +
                                '<div class="product-info col-12">' +
                                '<a class="bg-info color-white" onclick="agregarProducto(' + data[
