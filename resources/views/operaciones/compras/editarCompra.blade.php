...
<head>
    ...
    <title>Finalizar Compra Pendiente</title>
    <!-- CSS -->
    ...
    <link href="{{ asset('assets/css/newStyles.css?2022-08-13') }}" rel="stylesheet" type='text/css'>
...
<body class="sidebar-horizontal">
                ...
                <div class="container">
                    ...
                    <div class="row page-title clearfix">
                        <div class="page-title-left">
                            <h6 class="page-title-heading mr-0 mr-r-5">Finalizar Compra Pendiente</h6>
                        </div>
                        <!-- /.page-title-left -->
                    </div>
                    {{-- <div class="row">
                            ...
                            <div class="col-md-12 widget-holder">
                                <div class="widget-bg">
                                    <div class="widget-body clearfix form-material">
                                        ...
                                        {{ csrf_field() }} --}}
                                        <input hidden id="idCompraPendiente" class="form-control" type="text"
                                            value="{{ $idCompraPendiente }}" readonly>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <select id="selectTipoComp" class="form-control"
                                                        name="tipoComprobante">
                                                        {{-- <option value="0">{{ $reporte[0]->IdTipoComprobante }}</option> --}}
                                                        @foreach ($tipoComprobante as $tipCom)
                                                            @if ($datosComprasPendientes->IdTipoComprobante == $tipCom->IdTipoComprobante)
                                                                <option value="{{ $tipCom->IdTipoComprobante }}"
                                                                    selected>
                                                                    {{ $datosComprasPendientes->NombreComprobante }}
                                                                </option>
                                                            @else
                                                                <option value="{{ $tipCom->IdTipoComprobante }}">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input id="serie" class="form-control" placeholder="Serie"
                                                            ...
                                                            value="{{ $datosComprasPendientes->Serie }}">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input id="numero" class="form-control"
                                                            ...
                                                            value="{{ $datosComprasPendientes->Numero }}"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="m-b-10 form-control select2-hidden-accessible"
                                                        ...
                                                        @foreach ($proveedoresTickets as $proveedor)
                                                            @if ($datosComprasPendientes->IdProveedor == $proveedor->IdProveedor)
                                                                <option value="{{ $proveedor->IdProveedor }}"
                                                                    selected>
                                                                    {{ $datosComprasPendientes->Nombres }}</option>
                                                            @else
                                                                <option value="{{ $proveedor->IdProveedor }}">
                                                    ...
                                                    @if ($subniveles->contains('IdSubNivel', 46))
                                                        <select id="tipoMoneda" class="form-control disabled-elemento"
                                                            ...
                                                            @foreach ($tipoMoneda as $tipMon)
                                                                @if ($datosComprasPendientes->IdTipoMoneda == $tipMon->IdTipoMoneda)
                                                                    <option
                                                                        value="{{ $datosComprasPendientes->IdTipoMoneda }}"
                                                                        selected>
                                                ...
                                                <div class="form-group">
                                                    {{-- <div class="input-group">
                                                        <input id="datepicker" readonly type="text"
                                                            ...
                                                            value="{{ $datosComprasPendientes[0]->fechaCompras }}" required>
                                                        <div class="input-group-append">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="datepicker" type="text"
                                                            ...
                                                            value="{{ $datosComprasPendientes->fechaCompras }}"
                                                            required>
                                                        <div class="input-group-append">
                                                            <div class="input-group-text"><i
                                                                    class="list-icon material-icons">date_range</i>
                                            ...
                                            <div class="col-md-4">
                                                @if ($exonerado == 1 && $sucExonerado == 1)
                                                    <select id="tipoCompra" class="form-control" name="tipoCompra"
                                                        disabled>
                                                        @if ($datosComprasPendientes->TipoCompra == 1)
                                                            <option selected value="1">Venta Op. Gravada</option>
                                                        @else
                                                            <option value="1">Venta Op. Gravada</option>
                                                        @endif

                                                        @if ($datosComprasPendientes->TipoCompra == 2)
                                                            <option selected value="2">Venta Op. Exonerada
                                                            </option>
                                                        @else
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-lg-8 col-md-12">
                                                <div class="form-group">
                                                    <textarea id="observacion" class="form-control" rows="4" name="observacion">{{ $datosComprasPendientes->Observacion }}</textarea>
                                                ...
                                                <div id="interes" class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="_interes" type="number" step="any"
                                                            class="form-control" name="interes"
                                                            value="{{ old('interes') }}" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="fechaDepositoCompra" type="text"
                                                            ...
                                                            onkeydown="return false" value="{{ date('d/m/Y') }}"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div
                                            ...
                                            <button id="btnCompraPendiente" class="btn btn--verde guardarCompra"
                                                data-estado-compra='Pendiente' value="actualizarCompraPendiente"
                                                type="submit">Guardar
                                                Compra Como Pendiente</button>
                                            <button id="btnFinalizarCompra" class="btn btn--celeste guardarCompra"
                                                data-estado-compra='Registrado' value="finalizarCompraPendiente"
                                                type="submit">Finalizar
                                                Compra pendiente</button>
                                        </div>
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-12 d-flex">
                                                                                    @if ($tipoMonedaCompraPendiente == 1)
                                                                                        <span class="fs-22"
    ...
    <script>
        $(function() {
            $("#tipoMoneda").on('change', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: '../editar-compra/enviar-datos/select-productos',
                    data: {
            ...
            $("#categoria").on('change', function() {
                ...
                $.ajax({
                    type: 'get',
                    // url: '../editar-compra/enviar-datos/buscar-productos',
                        ...
                        for (var i = 0; i < data["data"].length; i++) {
                            $('#listaProductos').append(
                                ...
                                '" class="form-control product-price fs-16" value="' + data[
                                    "data"][i]["Costo"] + '" type="number" step="any"/>' +
                                '</div>' +
                                '<div class="col-12">' +
                                '<span class="text-muted">' + data["data"][i]["Marca"] +
                                '</span>' +
    ...
    <script>
        ...
        function getProductos(page) {
            ...
            $.ajax({
                type: 'get',
                // url: '../editar-compra/enviar-datos/productos?page=' + page,
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data["data"].length; i++) {
                        $('#listaProductos').append('<div class="product col-12 col-md-6">' +
                            ...
                            ["Precio"] + '" class="form-control text-center" readonly/>' +
                            '</div>' +
                            '</div>' +
                            '<div class="card-footer">' +
                            '<div class="product-info col-12">' +
    ...
    <script>
        $("#proveedores").on('change', function() {
            ...
            $.ajax({
                type: 'get',
                url: '../editar-compra/enviar-datos/comprobar-existencia',
                data: {
                    ...
                    if (data[0] == 'alert1') {
                        ...
                        if (data[0] == 'alert2') {
                            ...
                            if (data[0] == 'alert3') {
                                ...
                                limpiarSelectProveedores();
                                // $('#mensaje').append(
                                //     "<p  class ='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>La Serie y el Número ya se encuentran registrado</p>"
                                // );
    ...
    <script>
        $(function() {
            var itemsCompra = @json($arrayItemsDetalleCompra);
            var step;
            for (var i = 0; i < itemsCompra.length; i++) {
                ...
                if (itemsCompra[i]["IdUnidadMedida"] == 1) {
                    step = '';
                } else {
                    step = '0.05';
                }
                if (itemsCompra[i]["TipoCompra"] == 2) {
                    precioVenta = parseFloat(itemsCompra[i]["Precio"] / 1.18);
                    precioCosto = parseFloat(itemsCompra[i]["PrecioCosto"] / 1.18);
                } else {
                    precioVenta = itemsCompra[i]["Precio"];
                    precioCosto = itemsCompra[i]["PrecioCosto"];
                }
                productoEnTabla(itemsCompra[i]["IdArticulo"], itemsCompra[i]["Descripcion"], itemsCompra[i]["UM"],
                    precioVenta, precioCosto, itemsCompra[i]["Cantidad"], itemsCompra[i]["Importe"], step)
            }

            // Codigo Egreso
            // calcularNuevoMontoCaja(total, totalCaja);
            // insertarDataTextArea()
            // const tipoDocumento = ($("#selectTipoComp option:selected").text()).trimStart();
            // const serie = $("#serie").val();
            // const numero = $("#numero").val();
            // const proveedor = $("#proveedores option:selected").text();
            // $('#inputDescripcionEgreso').val(tipoDocumento.trimEnd() + ' ' + serie + '-' + numero +
            //     ' de ' + proveedor.trimStart());
            // Fin
        });
    </script>
    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            console.log(` TTTTTTTTTTTT ${  totalCompra}`);
        });
        $(function() {
            console.log(` compra.Total ${ compra.Total}`);
        })
        // let datosCaja = @json($datosCaja);
        $(function() {
        ...
        $(document).on('click', function(e) {
            if (e.target.closest('.botonAgregarProducto') || e.target.closest('.btnEliminarArticulo')) {
                mostrarMontoCajaEnPantalla();
                if (checkGuardarEgreso && totalMontoCaja < totalCompra) {
                    mostrarMensajeError(
        ...
        const cambiarMontoCaja = (tipoMoneda) => {
            console.log(`parseInt(tipoMoneda) ${tipoMoneda}`);
        ...
        const mostrarMontoCajaEnPantalla = () => {
            console.log(` compra.Total ${ compra.Total}`);
            $('#montoEgreso').text(redondeo(totalCompra));
            const nuevoTotalCaja = parseFloat(redondeo(totalMontoCaja)) - parseFloat(redondeo(totalCompra));
            // nuevoTotalCaja < 0 ? $('#nuevoTotalCaja').text(redondeo(0)) : $('#nuevoTotalCaja').text(redondeo(
            //     nuevoTotalCaja));
            console.log(`totalMontoCaja ${totalMontoCaja}`);
        ...
        const isMontoCajaMayorQueCompra = () => {
            return totalMontoCaja > totalCompra;
        }
        ...
        const insertarDataTextArea = () => {
            let tipoDocumento = $("#selectTipoComp option:selected").text().trim();
            const serie = $("#serie").val();
            const numero = $("#numero").val();
            let proveedor = $("#proveedores option:selected").text().trim();
            $('#inputDescripcionEgreso').text(
                `${tipoDocumento} de compra ${serie}-${numero} de ${proveedor}`)
        }
