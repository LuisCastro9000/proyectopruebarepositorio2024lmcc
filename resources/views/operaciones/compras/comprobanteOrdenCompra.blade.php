  ...
  @section('content')
      <div class="container">
          {{-- <div class="row page-title clearfix my-4">
              <div class="page-title-left">
                  <h6 class="page-title-heading mr-0 mr-r-5">Detalle Orden de Compra</h6>
              </div>
              <div class="page-title-rigth">
                  <a href="../../compras/convetir-orden-compra/{{ $ordenCompraSelect->IdOrdenCompra }}" ><button class="btn btn--naranja ripple"><i class="list-icon material-icons fs-20">add_to_photos</i>
                  ...
                  <a href="../../compras/imprimir-orden-compra/{{ $ordenCompraSelect->IdOrdenCompra }}"
                      target="_blank"><button class="btn btn-primary ripple"><i
                              class="list-icon material-icons fs-20">print</i></button></a>
                  <a target="_blank"
                      href="../../compras/descargar-orden-compra/{{ $ordenCompraSelect->IdOrdenCompra }}"><button
          ...
          <div class="row my-4">
              <div
                  class=" col d-flex justify-content-center flex-wrap align-items-center justify-content-md-between flex-column flex-sm-row">
                  <section class="mb-3 mb-md-0">
                      <h6 class="page-title-heading mr-0 mr-r-5">Detalle Orden de Compra</h6>
                  </section>
                  <section>
                      {{-- @if (strpos($idBtn, 'C-') !== false)
                          <p>hola</p>
                      @endif --}}
                      @if ( str_contains($idBtn, 'C-') != true)
                          <a href="../../compras/convertir-orden-compra/{{ $ordenCompraSelect->IdOrdenCompra }}" ><button
