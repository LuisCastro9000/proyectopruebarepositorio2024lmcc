        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap my-3">
            ...
            <div class="page-title-right">
                <div class=" d-flex flex-wrap">
                    ...
                    <a class="p-1" href="../imprimir-inventario/{{ $inventario->IdCheckIn }} " target="_blank"><button
                            class="btn btn-block btn-color ripple"><i
                                class="list-icon material-icons color-icon fs-20">print</i></button></a>
                    {{-- FIN --}}
                    <a class="p-1" href="../descargar-inventario/{{ $inventario->IdCheckIn }}"><button
                            class="btn btn-block btn-primary ripple"><i
                                class="list-icon material-icons fs-20">picture_as_pdf</i></button></a>
                    <a class="p-1" href="javascript:void(0);"><img class="logo-expand" alt="" width="40"
            ...
            <div class="modal fade" id="modalWhatsapp" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        {!! Form::open(['url' => '/operaciones/vehiculares/guardar-pdf', 'method' => 'POST', 'files' => true]) !!}
                                ...
                                <div class="col-12 text-center">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-center" name="numeroCelular"
                                            id="numeroCelular">
                                        <input type="hidden" name="idCheck" value="{{ $inventario->IdCheckIn }}">
                                    </div>
                                </div>
                            </div>
                        </div>
