        ...
        <div class="widget-list">
            <div class="row">
                <div class="col-md-12 widget-holder">
                    {!! Form::open([
                        'url' => '/operaciones/vehiculares/actualizar-check-list',
                        'method' => 'POST',
                        'files' => true,
                        'class' => 'form-material',
                    ]) !!}
                                    ...
                                    <td align="center">
                                        @if ($accExt->Estado != 'E')
                                            <input id="{{ $accExt->IdDescripcionCheckIn }}"
                                                name="chbox{{ $accExt->IdDescripcionCheckIn }}"
                                        ...
                                        <div class="radiobox" style="width: 380px;">
                                            <label>
                                                @if ($accExt->Estado == 1)
                                                    <input type="radio"
                                                        ...
                                                        value="1" checked> <span class="label-text m-4">Bueno</span>
                                                @else
                                                    <input type="radio"
                                                        name="radioOption{{ $accExt->IdDescripcionCheckIn }}"
                                            ...
                                            <label>
                                                @if ($accExt->Estado == 3)
                                                    <input type="radio"
                                                        name="radioOption{{ $accExt->IdDescripcionCheckIn }}"
                                                        value="3" checked> <span class="label-text m-4">Malo</span>
                                                @else
                                                    <input type="radio"
                                                        name="radioOption{{ $accExt->IdDescripcionCheckIn }}"
                                    ...
                                    <td align="center">
                                        @if ($accInt->Estado != 'E')
                                            <input id="{{ $accInt->IdDescripcionCheckIn }}"
                                                name="chbox{{ $accInt->IdDescripcionCheckIn }}"
                                    ...
                                    <td align="center">
                                        <div class="radiobox" style="width: 380px;">
                                            ...
                                            <label>
                                                @if ($accInt->Estado == 2)
                                                    <input type="radio"
                                                        name="radioOption{{ $accInt->IdDescripcionCheckIn }}" checked
                                    ...
                                    <td align="center">
                                        @if ($herramienta->Estado != 'E')
                                            <input id="{{ $herramienta->IdDescripcionCheckIn }}"
                                                name="chbox{{ $herramienta->IdDescripcionCheckIn }}"
                        ...
                        <tbody>
                            @foreach ($docVehiculos as $docVehi)
                                <tr>
                                    <td align="center">
                                        @if ($docVehi->Estado != 'E')
                                            <input id="{{ $docVehi->IdDescripcionCheckIn }}"
                                                name="chbox{{ $docVehi->IdDescripcionCheckIn }}"
