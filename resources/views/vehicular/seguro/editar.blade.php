                ...
                <div class="col-md-12 widget-holder">
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            {!! Form::open([
                                'url' => 'vehicular/administracion/seguros-vehiculares/' . $seguroSelect->IdSeguro,
                                'method' => 'PUT',
                                'files' => true,
                            ]) !!}
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Razón Social" type="text"
                                            name="razonSocial" value="{{ $seguroSelect->Descripcion }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="nroDocumento"
                                            value="{{ $seguroSelect->NumeroDocumento }}" maxlength="12">
                            ...
                            <div class="form-actions btn-list mt-3">
                                ...
                                <a href="../../seguros-vehiculares"><button class="btn btn-outline-default"
