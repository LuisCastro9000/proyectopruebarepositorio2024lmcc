    ...
    <div class="container">
        <div class="row my-4">
            <div class="col d-flex">
                <h6 class="mr-0 mr-r-5">Crear Paquete en: </h6>
                                ...
                                <div class="col-12">
                                    <div class="form-group text-center">
                                        <input class="form-control text-center" id="nombre" type="text" name="nombre"
                                            autocomplete="off">
                                        <label for="nombre">Ingrese Nombre de Grupo</label>
                                    </div>
                                </div>
                            </div>
                        </section>
                                                    ...
                                                    <div class="product col-12 col-md-6">
                                                        <div class="card-body">
                                                            ...
                                                            <input hidden id="p3-{{ $producto->IdArticulo }}"
                                                                value="{{ $producto->UM }}" />
                                                            <!-- esto puse 1 -->
                                                            <input id="IdUnidadMedida-{{ $producto->IdArticulo }}"
...
@section('scripts')
    ...
    <script>
        ...
        function agregarProducto(id) {
            ...
            productoEnTabla(id, descripcion, marca, categoria, precio, stock, codigoBarra, IdUnidadMedida);
            return 0;

        }

        function productoEnTabla(id, descripcion, marca, categoria, precio, stock, codigoBarra, IdUnidadMedida) {
            // Nuevo codigo
            if (IdUnidadMedida == 1) {
                step = '';
            } else {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data[0] == 'alert1') {
                        ...
                        if (data[0] == 'alert2') {
                            // alert(data[1]);
                            swal("Falta Ingresar items al Grupo", "Por favor ingrese los Items");
                            ...
                            if (data[0] == 'alert3') {
                                ...
                                swal({
                                    ...
                                    .then((Entendido) => {
                                        if (Entendido) {
                                            window.location =
                                                '../administracion/paquetes/detalle-paquete/' + data[
                                                    2];
                                        }
                                    });
                            }
