@extends('layouts.app')
@section('title', 'PaquetesPromocionales')
@section('content')
                ...
                <div
                    ...
                    <section>
                        <div class="mb-3 mb-sm-0">
                            <h6 class="page-title-heading mr-0 mr-r-5">Listado de Paquetes Promocionales</h6>
                        </div>
                    </section>
                    <section class="d-flex align-items-center flex-wrap justify-content-center">
                        <div class="d-md-block d-none">
                            <a href="../administracion/crear-paquete-promocional"><button
                                    class="btn btn-block btn-primary ripple"><i class="list-icon material-icons fs-24"
                                        value="1" name='btnSoles' id="btnSoles">add</i>Crear Paquete
                                </button></a>
                        </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="grupoSoles" role="tabpanel" aria-labelledby="nav-home-tab">
                        <table id="tableSoles" class="table table-responsive-sm" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($paquetesSoles as $paquete)
                                    <tr>
                                        <td>{{ $paquete->FechaCreacion }}</td>
                                        <td scope="row">{{ $paquete->NombrePaquete }}</td>
                                        <td align="center">
                                            <a href="../administracion/detalle-paquete_promocional/{{ $paquete->IdPaquetePromocional }}"
                                                class="btnDetalleGrupo" title="Ver Detalle"><i
                                                    class="list-icon material-icons">visibility</i></a>
                                            <a href="../administracion/editar-paquete_promocional/{{ $paquete->IdPaquetePromocional }}"
                                                title="Editar"><i class="list-icon material-icons">edit</i></a>
                                            <a class="fs-12 " title="Eliminar" href="javascript:void(0);"
                                                id="btnGrupo-{{ $paquete->IdPaquetePromocional }}"
                                                onclick="eliminarGrupo({{ $paquete->IdPaquetePromocional }})">
                    ...
                    <div class="tab-pane fade" id="grupoDolares" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <table id="tableDolares" class="table table-responsive-sm" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($paquetesDolares as $paquete)
                                    <tr>
                                        <td>{{ $paquete->FechaCreacion }}</td>
                                        <td scope="row">{{ $paquete->NombrePaquete }}</td>
                                        <td align="center">
        ...
        function eliminarGrupo(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = 'eliminar-paquete_promocional/' + id;
                }
            })
        }
    </script>
