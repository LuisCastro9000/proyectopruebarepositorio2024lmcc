            ...
            <div class="page-title-right">
                <div class="row mr-b-50 mt-2">
                    <div class="col-12 mr-b-20 d-sm-block d-none">
                        <a href="../administracion/operario/create"><button class="btn btn-block btn-info ripple"><i
    ...
    <script>
        ...
        $(function() {
            $("#exampleModal button.btnEliminar").on("click", function(e) {
                ...
                window.location = '../../vehicular/administracion/operario/' + id + '/delete';
            });
        });
    </script>
@stop
