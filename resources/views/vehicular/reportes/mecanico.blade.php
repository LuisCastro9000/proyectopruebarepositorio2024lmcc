...
@section('content')
    ...
    <div class="container">
        ...
        @endif
        {!! Form::open(['url' => '/vehicular/reportes/mecanico', 'method' => 'POST', 'files' => true]) !!}
        {{ csrf_field() }}
        <div class="row clearfix">
            ...
            <div class="col-lg-3 mt-4 ">
                <x-selectorFiltrosFechas :obtenerDatos="'false'" :tipoRangoFechas="'anual'" />
            </div>
            ...
            <div class="col-lg-1 col-sm-2 col-6 mt-0 mt-md-4  text-center ">
                ...
                <a class="" target="_blank"
                    href='{{ url("vehicular/reportes/excel-mecanico/$inputMecanico/$fecha/$ini/$fin") }}'>
        ...
        <x-inputFechasPersonalizadas :tipoRangoFechas="'anual'" :mostrarBoton="'false'" />
        {!! Form::close() !!}
    </div>
    <!-- /.container -->
    <!-- =================================== -->
