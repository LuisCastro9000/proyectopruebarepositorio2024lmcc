...
<body>
    <div class="container">
        ...
        <table width="100%" class="tabla2 mt-2">
            ...
            <tr>
                ...
                @if ($notaSelect->IdMotivo == 23)
                    <td width="20%">FECHA PAGO MODIFICADA:</td>
                    <td width="25%">{{ $fechaPago }}</td>
                @endif
            </tr>
        </table>
        ...
        <table width="100%">
            ...
            @if ($notaSelect->Gratuita > 0)
                <tr>
                    <td width="100%" colspan="3"><span class="negrita">TRANSFERENCIA GRATUITA DE UN BIEN Y/O
                            SERVICIO PRESTADO GRATUITAMENTE</span></td>
                </tr>
            @endif
        </table>
        <table width="100%" class="tabla4 borderTop borderBottom">
            ...
            <tbody>
                <tr>
                    <td class="borderTop" width="20%" align="center">{{ $notaSelect->Subtotal }}</td>
                    <td class="borderTop" width="20%" align="center">{{ $notaSelect->Gratuita }}</td>
                    <td class="borderTop" width="20%" align="center">{{ $notaSelect->Descuento }}</td>
                    <td class="borderTop" width="20%" align="center">{{ $notaSelect->IGV }}</td>
                    <td class="borderTop" width="20%" align="center">{{ $notaSelect->Total }}</td>
                </tr>
            </tbody>
        </table>
