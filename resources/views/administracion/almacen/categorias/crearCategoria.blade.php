    ...
    <div class="container">
        <div class="row page-title clearfix">
            <div class="page-title-left">
                <h6 class="page-title-heading mr-0 mr-r-5">Crear Categoría</h6>
            </div>
            <!-- /.page-title-left -->
        </div>
        <!-- /.page-title -->
                ...
                <div class="col-md-12 widget-holder">
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            {!! Form::open(['url' => '/administracion/almacen/categorias', 'method' => 'POST', 'files' => true, 'class' => 'form-material']) !!}
                            {{ csrf_field() }}
                            <div class="row">
                                @error('nombre')
                            ...
                            <div class="form-actions btn-list mt-3">
                                ...
                                <a href="../categorias"><button class="btn btn-outline-default"
