            ...
            <div class="container">
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        <h6 class="page-title-heading mr-0 mr-r-5">Editar Categoría</h6>
                    </div>
                    <!-- /.page-title-left -->
                </div>
                <!-- /.page-title -->
                        ...
                        <div class="col-md-12 widget-holder">
                            <div class="widget-bg">
                                <div class="widget-body clearfix">
                                    {!!Form::open(array('url'=>'administracion/almacen/categorias/'.$categoria->IdCategoria,'method'=>'PUT','files'=>true, 'class' => 'form-material'))!!}
                                        {{csrf_field()}}
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input class="form-control" id="nombre" placeholder="Nombre" type="text" name="nombre" value="{{$categoria->Nombre}}">
                                            ...
                                            <!--<div class="col-md-6">
                                                <div class="form-group">
                                                    <input class="form-control" id="nombre" placeholder="Descripción" type="text" name="descripcion" value="{{$categoria->Descripcion}}">
                                        ...
                                        <div class="form-actions btn-list mt-3">
                                            ...
                                            <a href="../../categorias"><button class="btn btn-outline-default" type="button">Cancelar</button></a>
                                        </div>
                                    {!!Form::close()!!}
                                </div>
                                <!-- /.widget-body -->
