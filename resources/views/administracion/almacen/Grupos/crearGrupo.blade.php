...
@section('scripts')
    ...
    <script>
        ...
        function getProductos(page, textoBusqueda, idCategoria, tipoMoneda) {
            ...
            $.ajax({
                type: 'get',
                url: '../Grupos/productos?page=' + page,
                data: {
                    'textoBuscar': textoBusqueda,
                    'tipoMoneda': tipoMoneda,
                    'idCategoria': idCategoria
        ...
        function getServicios(page, textoBusqueda, tipoMoneda) {
            $.ajax({
                ...
                url: '../Grupos/servicios?page=' + page,
                data: {
                    'textoBuscar': textoBusqueda,
                    'tipoMoneda': tipoMoneda
                },
                        ...
                        if (data[0] == 'alert2') {
                            ...
                            if (data[0] == 'alert3') {
                                ...
                                swal({
                                    ...
                                    .then((Entendido) => {
                                        if (Entendido) {
                                            window.location = '../../almacen/grupos/detalle-grupo/' + data[
                                                2];
                                        }
                                    });
                            }
