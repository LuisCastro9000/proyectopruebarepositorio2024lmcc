            ...
            <div class="col">
                <div
                    ...
                    <section class="d-flex align-items-center flex-wrap justify-content-center">
                        ...
                        <div class="d-md-block d-none mx-2">
                            <a href="../almacen/grupos/create"><button class="btn btn-block btn-primary ripple"><i
                            ...
                            <tbody>
                                @foreach ($grupoSoles as $grupo)
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="../almacen/grupos/detalle-grupo/{{ $grupo->IdGrupo }}"
                                                class="btnDetalleGrupo" title="Ver Detalle"><i
                                                    class="list-icon material-icons">visibility</i></a>
                                            <a href="../almacen/Grupos/editar/{{ $grupo->IdGrupo }}" title="Editar"><i
        ...
        function eliminarGrupo(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = 'eliminar-grupo/' + id;
                }
            })
        }
    </script>
