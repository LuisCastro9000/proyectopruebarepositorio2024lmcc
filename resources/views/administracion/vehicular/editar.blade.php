                ...
                <div class="col-md-12 widget-holder">
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            {!! Form::open([
                                'url' => '/administracion/vehicular/' . $vehiculo->IdVehiculo,
                                'method' => 'PUT',
                                'class' => 'form-material',
                            ]) !!}
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Placa" type="text"
                                            value="{{ $vehiculo->PlacaVehiculo }}" name="placa">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Ingrese el Número de Días"
                                            ...
                                            value="{{ $vehiculo->PeriodoMantenimientoKm }}">
                            ...
                            <div class="form-actions btn-list mt-3">
                                ...
                                <a href="../registrar"><button class="btn btn-outline-default"
