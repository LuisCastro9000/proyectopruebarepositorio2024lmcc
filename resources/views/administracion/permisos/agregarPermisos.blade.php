...
<body class="sidebar-horizontal">
            ...
            <div class="container">
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        <h6 class="page-title-heading mr-0 mr-r-5">Agregar permisos</h6>
                    </div>
                    <!-- /.page-title-left -->
                </div>
                <!-- /.page-title -->
                        ...
                        <div class="col-md-12 widget-holder">
                            <div class="widget-bg">
                                <div class="widget-body clearfix">
                                    {!!Form::open(array('url'=>'/administracion/permisos','method'=>'POST','files'=>true))!!}
                                        {{csrf_field()}}
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker form-control" name="permisos[]" multiple="multiple" data-style="btn btn-primary">
    ...
    <script>
        $(function () {
            var usuarios = <?php echo json_encode(count($usuarios));?>;
            if(usuarios == 0){
               alert("No hay usuarios nuevos para asignar permisos");
            }
        });
    </script>
