            ...
            <div class="container">
                <div class="row page-title clearfix">
                    <div class="page-title-left">
                        <h6 class="page-title-heading mr-0 mr-r-5">Listado de Niveles</h6>
                    </div>
                    <!-- /.page-title-left -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>@foreach($usuarioSubPermisos as $sub)
                                                  	...
                                                  	<td class="text-center">
                                                        <a href="{!! url('/permisos/agregar_nivel/'.$operador->IdUsuario.'/'.$permiso_general) !!}"><button title="Editar" class="btn btn-primary"><i class="list-icon material-icons">edit</i></button></a>
